            ...
            <div className="max-w-md mx-auto">
              ...
              <div className="divide-y divide-gray-200">
                ...
                <div className="text-center border-none">
                  <p className="mb-0 mt-1 pt-1 text-sm">
                    Don't have an account?
                    <a
                      href="/register"
                      className="text-red-800 transition duration-150 ease-in-out hover:text-red-600 focus:text-red-600 active:text-danger-700 ml-1 w-[100%]"
                    >
                      Register
                    </a>
                  </p>
