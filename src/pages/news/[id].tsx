    ...
    <div className="sm:w-[50%] md:w-[50%] lg:w-[90%] max-h-[600px] lg:max-h-[822px] mx-auto border rounded-xl shadow-custom overflow-y-scroll scroll sm:scroll-res">
      ...
      <div className="p-4">
        ...
        <p className=" text-justify ">
          ...
          Development တွေ အထိက ဝန်ဆောင်မူပေးနေတဲ့ ကုမ္ပဏီ တစ်ခုမှာ အလုပ်သင်စတင်
          ဝင်ရောက်ခဲ့ပါတယ်။ အတန်းတူ ကျောင်းတူ တက်နေတဲ့ထဲက နိုင်ငံခြားသားထဲမှာ
          ပထမဦးဆုံး ကုမ္ပဏီမှာ အလုပ်ရရှိခဲ့ပါတယ်။ ရရှိခဲ့တဲ့ အကြောင်းအရင်းကတော့
          ITPEC ရဲ့ အခြေခံ IP စာမေးပွဲကို အောင်မြင်ခဲ့တဲ့အတွက် IP သင်ကြားပေးတဲ့
          ဆရာရဲ့ မိတ်ဆက်ပေးခြင်းနဲ့ ရရှိခဲ့တာပါ။ အလုပ်သင်စဝင်တော့ တစ်လကို ယန်း
          ၅သောင်းပေးပါတယ်။ ၁ပတ်ကို ၂ကြိမ် အနည်းဆုံးကုမ္ပဏီကို သွားရတယ်။ ပြီးတော့
          လက်ခံတဲ့ အလုပ်တွေကို လုပ်ပြီး ပို့ပေးရတယ်။ ယန်း၅သောင်းဆိုတော့ အပြင်မှာ
          အချိန်ပိုင်းအလုပ်လုပ်ရင် နာရီ ၅၀ စာ ဝင်ငွေဖြစ်ပါတယ်။ အစပိုင်းတော့
          လောဘတွေတက်ပြီး အချိန်ပိုင်း အလုပ်ကိုလည်း မလျော့ပဲ အလုပ်သင်ကလည်းဝင်ငွေ
          ရရှိတဲ့အဲတွက် သာယာနေခဲ့ပေမယ့် စာကျက်ချိန် မရှိတာရယ်
          နည်းပညာပိုင်းလေ့လာမူအားနည်းတော့ အလုပ်သင် ကုမ္ပဏီအတွက်
          ...
          အသုံးပြုပြီး Voting System တွေကို ရေးဆွဲပေးရတယ်။ အလုပ်ဝင်တဲ့ ကုမ္ပဏီက
          ကုမ္ပဏီ အကြီးကြီးမဟုတ်တဲ့အတွက် အစအဆုံး တစ်ယောက်ထဲ လုပ်ရတာတွေများပါတယ်။
          အဲဒီအတွက် ပိုပြီး ပညာရရှိခဲ့တယ်လို့ ထင်တယ်။ အမှတ်တရအနေနဲ့ နာမည်ကြီး
          Brand တစ်ခုရဲ့ Model Voting ပေးတဲ့စနစ်ကို တစ်ယောက်တည်း ရေးရတဲ့အပြင်
          Voting စလက်ခံတဲ့နေကနေ စပြီး ၁ပတ်လောက်က ညလုံးပေါက် အခြေအနေတွေ
          စောင့်ကြည့်ခဲ့ရတာလည်းရှိပါတယ်။ Programmer တစ်ယောက်ဟာ Develop
          လုပ်နေချိန်မှာ သူများနဲ့မတူအောင် စိတ်ဖိစီးမူ ခံစားရပြီး
          လုပ်ထားတဲ့အရာကို အများရှေ့မှာ ချပြတဲ့အခါ ပြောမပြနိုင်တဲ့
          ...
          ဂျပန်မှာ အလုပ်သင်ဆိုတာကလည်း အလုပ်ထဲမှာ စာသင်ပေးတာမျိုးမဟုတ်ပဲ လက်တွေ့
          တစ်ယောက်တည်း လုပ်ခိုင်းပြီး မှားမှ အကြံညာဏ်ပေးတာမျိုးဆိုတော့
          အလွယ်တကူတော့မဟုတ်ဘူး။ စစခြင်း ၆လ လောက်က ငရဲ့ ကျနေသလိုမျိုး ခံစားရတယ်။
          အဲဒါကို ကျော်ဖြတ်နိုင်ရင်တော့ နိဗ္ဗာန် နီးလာပြီးလို့
