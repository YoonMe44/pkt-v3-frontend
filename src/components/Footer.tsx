...
const Footer = () => {
  return (
    <>
      <div className="w-full px-4 bg-[#F5F5F5] py-20 flex lg:flex-row md:flex-col">
        <div className="w-1/3 flex flex-col mx-auto">
          <div className="mx-auto mb-[14.48px]">
            <Image
              src="/images/pkt.png"
              width={100}
              height={100}
          ...
          <p className="lg:px-24 text-sm text-center">
            PKT Education Center is now teaching Japanese language and
            technology for the future and achieving a successful life goal...
          </p>
        </div>

        <div className="w-1/3 flex flex-col items-center md:hidden lg:flex">
          <div className="items-center">
            <h1 className="text-2xl text-red-600">Information For</h1>
            <div className="flex justify-start mt-12">
              <div className="flex flex-col mr-[75px]">
                <a
                  href="#"
                  className="text-zinc-500 hover:opacity-50 text-sm mb-3"
                >
                  Home
                </a>
                <a
        ...
        <div className="w-1/3  flex-col md:hidden lg:flex">
          <h1 className="text-2xl text-red-600 mb-[38px]">Address</h1>
          <div className="flex">
            <svg
            ...
            <a
              href="#"
              className="mb-3 ml-4 text-zinc-500 hover:opacity-50 text-sm "
            >
          ...
          <div className="flex">
            ...
            <a
              ...
              className="mb-3 ml-4 text-zinc-500 hover:opacity-50 text-sm "
            >
              No(71), Room A, Ground Floor,<br></br> Upper Pazundaung Road
              Mingalar <br></br> Taung Nyunt Township,Yangon.
            </a>
          </div>
        </div>
        ...
        <div className="grid grid-rows-1 grid-cols-2 mt-[22px] px-24">
          <div className="w-full pl-4 lg:hidden">
            <h1 className="text-xl text-center text-red-600 mb-[38px]">
              Address
            </h1>
            <div className="flex">
              <svg
              ...
              <a
                href="#"
                className="mb-1 ml-4 text-zinc-500 hover:opacity-50 text-sm "
              >
                +959 251801804, +959 251801805
              </a>
            </div>
            <div className="flex mt-4">
              ...
              <a
                href="#"
                className="w-full  ml-4 text-zinc-500 hover:opacity-50 text-sm"
              >
          ...
          <div className="w-full lg:hidden">
            <div className="">
              <h1 className="text-xl text-red-600 mb-[38px]">
                Information For
              </h1>
              <div className="flex justify-start gap-4">
                <div className="flex flex-col">
                  <a
                    href="#"
                    className="text-zinc-500 hover:opacity-50 text-sm mb-1"
                  >
                    Home
                  </a>
                  <a
                ...
                <div className="flex flex-col">
                  ...
                  <a
                    href="#"
                    className="text-zinc-500 hover:opacity-50 text-sm"
                  >
                    Contact us
                  </a>
                </div>
