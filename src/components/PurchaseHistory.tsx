  ...
  return (
    <div className="sm:w-[80%] w-[83%] md:w-[80%] lg:w-[60%]  mx-auto mt-[250px] ">
      <div className="bg-[#F0F0F0] shadow-custom container  mx-auto rounded-lg lg:rounded-3xl my-4 pt-4 overflow-hidden  ">
        ...
        <div className="relative mx-auto w-fit my-9 flex mt-[100px] mb-[100px] justify-center">
          <div className="flex">
            <Link href={"/mypage/purchasehistory"}>
              <svg
                ...
                height="1.5em"
                viewBox="0 0 512 512"
                className=" absolute -left-10 top-8 fill-red-main duration-200 ease-in-out s:pl-[10px]"
              >
            ...
            <div>
              ...
              <Link href={"/mypage/register_courses"}>
                <svg
                  ...
                  height="1.5em"
                  viewBox="0 0 448 512"
                  className="absolute -right-10 top-8 rotate-90 fill-slate-500  hover:fill-red-main duration-200 ease-in-out s:pr-[25px] s:mt-[14px]"
                >
