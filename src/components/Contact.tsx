...
const Contact = () => {
  ...
  return (
    <div className="sm:w-1/2 md:w-1/2 lg:w-3/4 mx-auto border-solid border-2 flex flex-wrap rounded-xl py-20 px-10 bg-[rgba(255,255,255,0.17)] shadow-md inset-shadow-md">
      ...
      <div className="w-2/3">
        <div>
          <i className="md:text-xl text-red-main mt-4 font-medium">Sent a Message</i>
          ...
          <form className='mt-10 mr-10'>
            <div className="grid md:grid-cols-2 md:gap-6">
              ...
              <div className="relative z-0 w-full mb-6 group">
                <input type="email" name="floating_email" id="floating_email" className="block py-3.5 px-0 w-full text-sm text-black bg-transparent border-0 border-b-[3px] border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-gray-500 peer" placeholder=" " required />
            ...
            <div className="grid md:grid-cols-2 md:gap-6">
              ...
              <div className="relative z-0 w-full mb-6 group">
                ...
                <select
                  ...
                  required
                >
                  <option value="" className='text-md text-gray-500'>Interested In</option>
              ...
              <div className="relative z-0 w-full mb-6 group">
                <input type="tel" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" name="floating_phone" id="floating_phone" className="block py-3.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-[3px] border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-gray-500 peer" placeholder=" " required />
                <label htmlFor="floating_phone" className="peer-focus:font-medium absolute text-md text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-red-main peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Phone Number</label>
              </div>
            </div>
            <div className="relative z-0 w-full mb-6 group">
              <textarea name="floating_first_name" rows={4} id="floating_first_name" className="block py-3.5 px-0 w-full text-sm text-gray-900 bg-transparent border-b-[3px] border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-gray-500 peer" placeholder=" " required ></textarea>
      ...
      <div className="border-l-[4px] w-1/3">
        <div className='ml-8 mt-8'>
          ...
          <div className='pt-10'>
            ...
            <p className="text-md text-slate-500 font-medium mt-6">
              Leverage PKT to further your future. For those who want to inquire, you can come and inquire without any holidays
            </p>
            <div className='flex mt-4'>
              ...
              <div className="flex-1 w-32  text-sm font-medium text-red-main">
                No(71), Room A, Ground Floor, Upper Pazundaung Road Mingalar Taung Nyunt Township,Yangon.
              </div>
            </div>
